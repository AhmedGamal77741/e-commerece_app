            ...
            builder: (context) {
              ...
              return Scaffold(
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            Padding(
                              ...
                              child: TextButton(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Flexible(
                                      child: userAddressAsync.when(
                                        data: (addressData) {
                                          String displayName = '배송지 선택';
                                          if (addressData != null) {
                                            final basic = addressData['address'] as String? ?? '';
                                            final detail = addressData['detailAddress'] as String? ?? '';
                        ...
                        TabBar(
                          ...
                          isScrollable: true,
                          tabs: categories
                              .map((category) => Tab(text: category['name'], height: 45.h))
                              .toList(),
                        ),
                      ],
                    ),
                ...
                body: Padding(
                  ...
                  child: TabBarView(
                    children: categories
                        .map((category) => CategoryProductsScreen(
